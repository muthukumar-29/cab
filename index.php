                ...
                <div class="col-12 col-md-6 d-none d-md-block">
                    ...
                    <div class="mt-4">
                        <div class="d-md-flex flex-row">
                            ...
                            <p class="w-100 phn-no">+91 98765 43210</p>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-12">
                ...
                <div class="testimonial-card">
                    ...
                    <div class="d-flex flex-row">
                        <img src="https://via.placeholder.com/60" alt="Profile" class="profile-image mr-5">
                        <div>
                            <div class="name">Prema</div>
